export const blogArticles = [
  {
    ...
    title: "El hallazgo del Folio 22: Un proceso inquisitorial olvidado",
  ...
  {
    slug: "ermitano-siglo-xvii",
    title: "¿Qué significaba ser un ermitaño en el siglo XVII?",
  ...
  {
    slug: "esculpiendo-silencio",
    title: "Esculpiendo el silencio: El rostro de Joseph",
    category: "Memoria y Arte",
    date: "Ráquira, Boyacá",
  ...
  {
    slug: "auto-de-fe-1688",
    title: "El Auto de Fe de 1688 en Cartagena de Indias",
    category: "Contexto Histórico",
    date: "Cartagena de Indias",
    ...
    content: [
      ...
      "En toda la muestra del Archivo Histórico Nacional, desde la creación del Tribunal de Cartagena de Indias en 1610 hasta su cierre en 1821, la pena máxima de 'relajación en la hoguera' fue extremadamente rara.",
      "Los condenados a relajar en la hoguera fueron un protestante inglés, tres judaizantes portugueses y dos condenados por proposiciones heréticas. De estos dos últimos, uno fue relajado en estatua y el otro, Joseph Ximénez, fue quemado vivo en el mismo auto de fe el 30 de mayo de 1688.",
      "Su caso es insólito porque fue el único místico, ermitaño y escritor acusado de hereje dogmatizante. Sus doce años de cárcel secreta no le arrancaron ni una sola retractación, porque estaba firmemente convencido de que sus escritos eran un mandato directo de Dios."
    ]
  },
  {
    slug: "frontera-mental-misticismo",
    title: "La frontera mental del misticismo",
    category: "Psicología y Fe",
    date: "Análisis",
    ...
    content: [
      ...
      "Un personaje como Joseph Ximénez se ubica en los márgenes de la sociedad colonial neogranadina. No es como la gente de los más bajos estratos sociales porque sabe leer y escribir; pero tampoco es un hombre ilustrado.",
      "Su marginalidad se relaciona con la función del ermitaño como intermediario entre la mentalidad de la iglesia y la de los hombres. Él se creía en una posición privilegiada, en el borde que separa a Dios de los hombres.",
      "Esta independencia de pensamiento era letal en el siglo XVII. Joseph acomodaba la doctrina católica en su mente y la enseñaba en un lenguaje sencillo. Esa libertad, vista como herejía dogmatizante, fue lo que lo llevó finalmente al Auto de Fe."
    ]
  }
];
