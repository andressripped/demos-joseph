...
export const SectionCita = () => {
  return (
    <section id="cita" className="py-40 px-6 text-center" style={{ background: "rgba(193,83,59,0.05)", borderTop: "1px solid rgba(193,83,59,0.08)", borderBottom: "1px solid rgba(193,83,59,0.08)" }}>
